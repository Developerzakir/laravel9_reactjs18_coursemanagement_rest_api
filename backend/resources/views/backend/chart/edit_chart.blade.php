...
<div class="content-body" style="min-height: 788px;">
        ...
        <form method="post" action="{{ route('update.chart') }}" >
            ...
            <input type="hidden" name="id" value="{{ $chartEdit->id }}">
         ...
         <input type="text" name="x_data" class="form-control input-default " value="{{ $chartEdit->x_data }}"  >
            @error('x_data')
         ...
         <input type="text" name="y_data" class="form-control input-default " value="{{ $chartEdit->y_data }}"  >
            @error('y_data')
            <span class="text-danger">{{ $message }}</span>
            @enderror
