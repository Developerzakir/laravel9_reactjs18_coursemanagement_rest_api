<div class="deznav">
    <div class="deznav-scroll">
        ...
        <ul class="metismenu" id="menu">
           ...
           <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('all.homecontent') }}">All Home Content</a></li>
                    <li><a href="{{route('add.homecontent')}}">Add Home Content </a></li>
                </ul>
            </li>
        ...
        <div class="copyright">
            <p><strong>BD Learning Center Admin Dashboard</strong> © 2024 All Rights Reserved</p>
            <p class="fs-12">Made with <span class="heart"></span> by ZakirBD</p>
        </div>
    </div>
</div>