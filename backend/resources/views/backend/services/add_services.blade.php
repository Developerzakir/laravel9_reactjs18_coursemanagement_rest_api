                        ...
                        <div class="basic-form">
                            <form method="POST" action="{{route('service.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="service_text" rows="4" ></textarea>
                                    @error('service_text')
                                    <span class="text-danger">{{$message}}</span>         
                                    @enderror
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    <img id="showIMG" src="{{url('upload/no_image.jpg')}}" style="width:100px; height:100px;" class="img-fluid rounded-circle" alt="">
                                </div>
