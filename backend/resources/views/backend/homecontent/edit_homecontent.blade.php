...
<div class="content-body" style="min-height: 788px;">
        ...
        <form method="post" action="{{ route('homecontent.update') }}" >
         ...
         <div class="form-group">
                ...
                <textarea class="form-control" name="tech_desc" id="summernote">
                    {{ $homecontent->tech_desc }}
                </textarea>
            </div>
    ...
    <div class="form-group">
         ...
         <input type="text" name="total_review" class="form-control input-default " value="{{ $homecontent->total_review }}" >
           ...
           <div class="form-group">
                ...
                <textarea class="form-control" name="video_desc" id="summernote2">
                    {{ $homecontent->video_desc }}
                </textarea>
            </div>
